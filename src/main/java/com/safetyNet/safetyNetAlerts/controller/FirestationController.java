...
public class FirestationController {
    ...
    public List<Firestation> getFirestationByAddress(@PathVariable String address) {
        ...
        if(firestations == null){
            ...
            throw new RuntimeException("Impossible de trouver une station de pompiers à cette l'adresse");
        }
        return firestations;
    }
    ...
    public List<Firestation> getFirestationsByStation(@PathVariable String station) {
        ...
        if(firestations.isEmpty()){
            ...
            throw new RuntimeException("Impossible de trouver une station de pompiers avec ce numéro");
        }
        return firestations;
    }
