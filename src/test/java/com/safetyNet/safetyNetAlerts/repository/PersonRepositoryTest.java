...
public class PersonRepositoryTest {
    ...
    private void initPersons() {
        ...
        person2 = new Person();
        person2.setFirstName("Jad");
        person2.setLastName("Chaar");
    ...
    @Test
    public void getPersonByNameAndFirstTest() {
        Person person = personRepository.getPersonByNameAndFirstName("David", "Chaar");
    ...
    public void deletePersonShouldDeleteCorrectPerson() {
        personRepository.deletePerson("David", "Chaar");
    ...
    public void updatePersonShouldUpdateCorrectPerson() {
        ...
        assertEquals("City2", personRepository.getPersonByNameAndFirstName("David", "Chaar").getCity());
    }
